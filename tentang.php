    ...
    <div class="banner_inner d-flex align-items-center">
        ...
        <div class="container">
            <div class="banner_content text-center">
                <h2 data-aos="fade-up" data-aos-duration="1600">Tentang BRIGHT PLN BATAM</h2>
...
<section class="about_area p_60">
    <div class="container">
        <div class="main_title">
            <h2 data-aos="fade-up" data-aos-duration="1600" style="font-size: 33px !important;">Tentang BRIGHT PLN BATAM</h2>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                            “Menjadi Penyedia Listrik Terbaik dan Solusi Terintegrasi di Asia Tenggara”
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                            “Menyediakan tenaga listrik secara efisien dan andal serta jasa lainnya dalam bidang energi untuk meningkatkan kualitas hidup dan ekonomi masyarakat melalui pelayanan yang terbaik dan bertumpu pada sumber daya manusia.”
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header" id="headingThree">
                            ...
                            Nilai Perusahaan/Corporate Values AKHLAK :
                                <i class="lnr lnr-chevron-down"></i>
                                <i class="lnr lnr-chevron-up"></i>
                            </button>
                        </div>
...
<p>Kompeten = Terus belajar dan mengembangkan kapabilitas</p>
<p>Harmonis = Saling peduli dan menghargai perbedaan</p>
<p>Loyal = Berdedikasi dan mengutamakan kepentingan bangsa dan negara</p>
<p>Adaptif = Terus berinovasi dan antusias dalam menggerakkan ataupun menghadapi perubahan</p>
<p>Kolaboratif = Membangun kerja sama yang sinergis</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
            ...
            <div class="col-lg-6">
                <div class="video_area" id="video">
                    <img class="img-fluid" src="<?= base_url('assets/') ?>img/" alt="" />
                    <a class="popup-youtube" href="">
                        <img src="<?= base_url('assets/') ?>img/icon/" alt="" />
                    </a>
                </div>
            </div>
        </div>
