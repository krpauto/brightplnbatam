...
CREATE TABLE `pelanggan` (
  `no_ktp` int(64) NOT NULL,
  `alamat` varchar(255) NOT NULL,
  `no_hp` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `id_pln` varchar(255) NOT NULL,
...
INSERT INTO `pelanggan` (`no_ktp`, `alamat`, `no_hp`, `email`, `id_pln`, `isp_provider`, `koordinat`) VALUES
(24323523, 'Batu Aji', '081234654788', 'hacktoaa12@gmail.com', '23455555', '10 Mbps', 'Batu Aji');
...
(39, 'Aktivator', '$2y$10$djI2M/FQH2k3H7b6tLK5X.MZG1R.wrARoR6NerH3tsScNnsNCnexa', 'aktivitator@gmail.com', '73349393_156861225523800_2119508204152772215_n_(1)6.jpg', 1, 1586163321),
(47, 'obed', '$2y$10$ItC8EyrKFrTL5JRovu6Li.fJjvWX2xXdrhVuqNEF2FmO7MB05Ibc.', 'obedaja1@gmail.com', 'default.jpg', 1, 1663777125);
...
--
ALTER TABLE `pelanggan`
  MODIFY `no_ktp` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24323524;
